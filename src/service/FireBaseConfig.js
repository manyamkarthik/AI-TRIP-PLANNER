...
const firebaseConfig = {
  ...
  databaseURL: process.env.REACT_APP_GOOGLE_FIREBASE_DOMAIN_URL,
  projectId: process.env.REACT_APP_GOOGLE_FIREBASE_PROJECTID,
  storageBucket: process.env.REACT_APP_GOOGLE_FIREBASE_STORAGE_BUCKET,
  messagingSenderId: process.env.REACT_APP_GOOGLE_FIREBASE_MESSAGING_SENDERID,
  appId:process.env.REACT_APP_GOOGLE_FIREBASE_APPID ,
